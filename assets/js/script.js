...
function fetchData(value){
    ...
    .then((response) => {
        ...
        // document.getElementById('day_' + i + '--header').textContent = yyyymmdd_to_mmdd(data.list[f].dt_txt.slice(0, 10)) + emoji
        document.getElementById('city_name').textContent = data.city.name + " | " + weekday[d.getDay()] + "\n " + yyyymmdd_to_mmmdd(data.list[0].dt_txt.slice(0, 10))
...
// day_3--sub_header 
        ...
        weatherType = data.list[f].weather[0].main
        if(weatherType === 'Clear'){
            ...
            document.getElementById('day_' + i + '--header').textContent = weekday[d.getDay()+(i-1)] + " | " + yyyymmdd_to_mmmdd(data.list[f].dt_txt.slice(0, 10)) + emoji
